...
![Profile Views](https://komarev.com/ghpvc/?username=idkazlaan&style=for-the-badge&color=8b5cf6&label=PROFILE+VIEWS)
![Followers](https://img.shields.io/github/followers/idkazlaan?style=for-the-badge&color=7c3aed&labelColor=1a1a2e)
![Stars](https://img.shields.io/github/stars/idkazlaan?style=for-the-badge&color=6d28d9&labelColor=1a1a2e)
...
Scriptwriting · Directing · Video Editing · Colour Grading
...
Content Strategy · Reels · Community Engagement
...
| Area | Strengths |
|---|---|
| Web Development | Clean UI design, responsive layouts, translating design ideas into functional pages |
| Filmmaking | End-to-end production — scripting, directing, editing, colour grading |
| Social Media | Content strategy, Instagram management, Reels, community engagement |
| Soft Skills | Creativity, Communication, Team Leadership, Time Management |
...
Multiple websites built as part of BCA coursework and personal projects — focused on clean UI design and responsive layouts, translating design ideas into functional web pages.

| Aspect | Details |
|---|---|
| **Stack** | HTML, CSS, JavaScript |
| **Focus** | Clean UI design, responsive layouts |
| **Type** | College coursework & personal projects |
| **Timeline** | 2023 – Present |
| **Repository** | [View on GitHub](https://github.com/idkazlaan) |

Each project focuses on turning a design concept into a fully functional, responsive web page — building a solid foundation in front-end fundamentals.

</details>

<details>
<summary><b>🔹 Short Film & Original Series</b></summary>
<br/>

An independent short film and original series, written and directed solo — covering the full process from scripting to final edit.

| Aspect | Details |
|---|---|
| **Role** | Writer, Director, Editor |
| **Process** | Pre-production, production, post-production |
| **Tools** | Adobe Premiere Pro, colour grading |
| **Timeline** | 2023 – Present |
| **Type** | Independent filmmaking |

Managed every stage independently — from scripting and directing to editing and colour grading — demonstrating end-to-end creative production skills.
...
**Social Media Management — Freelance Client**

Managed content strategy and day-to-day posting for a client's Instagram presence.

`Content Strategy` `Instagram Management` `Reels` `Community Engagement`

<br/>

**Wedding Video — Freelance Client**

Delivered a full wedding video project, from filming through to final edit.

`Video Editing` `Colour Grading` `Client Delivery`

<br/>

**Core Member — Recognised Community Organisation**

Cleared competitive interviews to join as a Core Member of a recognised community organisation on campus.
...
| Recognition | Details |
|---|---|
| 🌟 Core Member | Selected after clearing competitive interviews at a recognised community organisation |
| 🎬 Independent Filmmaker | Wrote, directed, and edited an original series and a short film solo |
| 💼 Freelance Delivery | Delivered real client projects — social media management & wedding video |
...
<img src="https://github-profile-trophy.vercel.app/?username=idkazlaan&theme=darkhub&no-frame=true&column=7&margin-w=8&margin-h=8" width="100%"/>
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username=idkazlaan&theme=tokyo-night&hide_border=true&bg_color=0d1117&color=a78bfa&line=8b5cf6&point=c9d1d9" width="100%"/>
...
<img src="https://raw.githubusercontent.com/idkazlaan/idkazlaan/output/github-contribution-grid-snake-dark.svg" width="100%"/>
...
```yaml
Learning:
  - Advanced JavaScript and responsive web design
  - New video editing and colour grading techniques

Building:
  - More personal & college web development projects
  - New short-form content for social platforms

Exploring:
  - Freelance opportunities in web dev and content creation
